...
public class IRPF {
    ...
    public void cadastrarPrevidenciaOficial(float contribicaoPrevidenciaria){
        this.contribicaoPrevidenciaria = contribuicaoPrevidenciaria;
    }

    public float getPrevidenciaOficial(){
        return this.contibuicaoPrevidenciaria;
    }
